...
<body>
    ...
    <div class="container">
        ...
        <div style="display: flex; justify-content: center;">
            <a href="/">
                <img src="{{ asset('assets/images/logo-unz.jpg') }}" alt="logo de unz" width="100px"></a>
            @if ($errors->has('login'))
        ...
        <form action="{{ route('connexion-atos-action') }}" method="POST" enctype="multipart/form-data">
            ...
            <div style="display: flex; justify-content: center;">
                <button class="submit"
                    style="background-color: #3498db; padding: 10px; border-radius: 10px; border:none; color:white; cursor: pointer; font-size:15px">Connexion</button>
            </div>
            <br>
            <div style="display: flex; justify-content: center;">
