...
@section('titre', "Les ufrs de l'UNZ")
...
@section('contenu')
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            @endif
                <h2>Gestion des ufrs</h2>
            {{-- bouton de l'ajout  --}}
            <div class="d-flex justify-content-end">
                <a href="#" class="btn btn-outline-primary" data-bs-toggle="modal"
                    data-bs-target="#exampleModalEditionUfr" title="Cliquez ici pour ajouter une ufr">
                    Ajouter un ufr
                </a>
            </div>
            {{-- fin du botton --}}
            ...
            <div class="modal fade" id="exampleModalEditionUfr" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                        ...
                        <tr>
                            ...
                            <th>
                                <div class="d-flex justify-content-center">
                                    <a href="{{route('admin.ufr.modifier', $ufr)}}" class="btn btn-success col-4 text-white" style="margin-right: 10px; width: 124px">
                                        Modifier
                                    </a>
                                    <form action="{{route('admin.ufr.supprimer', $ufr)}}" method="POST">
                                        @csrf
                                        @method('delete')
