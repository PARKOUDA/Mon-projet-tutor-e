        ...
        <div class="content-wrapper">
            ...
            <div class="d-flex justify-content-end">
                <a href="#" class="btn btn-outline-primary" data-bs-toggle="modal"
                    data-bs-target="#exampleModalEditionGrade" title="Cliquez ici pour ajouter un grade">
                    Ajouter un grade
                </a>
            </div>
            {{-- fin du botton --}}
            ...
            <div class="modal fade" id="exampleModalEditionGrade" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                        ...
                        <tr>
                            ...
                            <th>
                                <div class="d-flex justify-content-center">
                                    <a href="{{route('admin.grade.modifier', $grade)}}" class="btn btn-success col-4 text-white" style="margin-right: 10px; width: 124px">
                                        Modifier
                                    </a>
                                    <form action="{{route('admin.grade.supprimer', $grade)}}" method="POST">
                                        @csrf
                                        @method('delete')
