        ...
        <div class="content-wrapper">
            ...
            <div class="d-flex justify-content-end">
                <a href="#" class="btn btn-outline-primary" data-bs-toggle="modal"
                    data-bs-target="#exampleModalEditionFonction" title="Cliquez ici pour ajouter fonction ">
            ...
            <div class="modal fade" id="exampleModalEditionFonction" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                        ...
                        <tr>
                            ...
                            <th>
                                <div class="d-flex justify-content-center">
                                    <a href="{{route('admin.fonction.modifier', $fonction)}}" class="btn btn-success col-4 text-white" style="margin-right: 10px; width: 124px">
                                        Modifier
                                    </a>
                                    <form action="{{route('admin.fonction.supprimer', $fonction)}}" method="POST">
                                        @csrf
                                        @method('delete')
